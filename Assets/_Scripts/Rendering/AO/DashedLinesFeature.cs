...
public class DashedLinesFeature : ScriptableRendererFeature
{
   
    //Own stuff for render
    [SerializeField] private Material m_dashedLinesMaterial;


    //Stuff from unitys SSAO script
    ...
    private DashedLinesPass m_dashedLinesPass;
...
#endif
        // Create the pass...        
        m_dashedLinesPass = new DashedLinesPass(m_dashedLinesMaterial);
    ...
    public override void AddRenderPasses(ScriptableRenderer renderer, ref RenderingData renderingData)
    {
        ...
        bool shouldAdd = m_dashedLinesPass.Setup(ref m_Settings, ref renderer, ref m_Material, ref m_BlueNoise256Textures);
        if (shouldAdd)
            renderer.EnqueuePass(m_dashedLinesPass);
    }
    protected override void Dispose(bool disposing)
    {
        m_dashedLinesPass?.Dispose();
        m_dashedLinesPass = null;
